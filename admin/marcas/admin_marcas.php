...
<head>
    ...
    <title>KBEVI/Admin/Marcas</title>
    ...
    <main class="main__admin">
        ...
        <table class="main__admin__db__table">
                ...
                <tr class="main__admin__db__table__tr">
                    ...
                    <td><a href="update_marca.php?id=<?= $row['IdMarca']?>" class="main__admin__db__table__edit">Editar</a></td>
                    <td>
                        <form action="delete_marca.php" method="post" class="main__admin__db__table__seguro">
        ...
        <div class="main__admin__container">
            <form action="create_marca.php" method="POST">
                <article>        
                    <input type="text" name="Nombre" required  class="main__admin__container__form" placeholder="Nombre:"><br><br>
                </article>
                <article>        
                    <input type="text" name="Desc" required  class="main__admin__container__form" placeholder="Descripción:"><br><br>
                </article>  
